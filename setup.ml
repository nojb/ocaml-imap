...
(* OASIS_START *)
(* DO NOT EDIT (digest: 80934abae04d254f6628ad5e9cc17ec6) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = [];
                      lib_pack = false;
                      lib_internal_modules = ["Imap_io"; "Imap_io_low"];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\135\015ø‡\022Âye\030t≥R∑\021p÷";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
