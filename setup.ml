...
(* OASIS_START *)
(* DO NOT EDIT (digest: cd5b00cca2dab99d11462bf8c49334fb) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Imap_gen_io"];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Jø²1Á\004æQ\135Ê³\130©-Kü";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
