...
(* OASIS_START *)
(* DO NOT EDIT (digest: 02fbfe3554123db521e8937221a8fbc4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "IMAP4rev1 protocol codec";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "imap_shell.ml"});
               Executable
                 ({
                     cs_name = "wait_mail";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "wait_mail.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "5thx^îÿÄIcòÅ\027Æ\154\140";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
