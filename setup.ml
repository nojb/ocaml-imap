...
(* OASIS_START *)
(* DO NOT EDIT (digest: 341a444902723a32c4d2d4c657e0e6a5) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_mutf7",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_mutf7", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_live",
          ...
          ("test_condstore",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_condstore", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_id",
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$test_namespace", ["-runner"; "sequential"]))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ...
       [
          ("imap",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "imap"})
       ];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "GNU SASL support";
                      flag_default =
                        [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Lwt support";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "all", true)
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Async support";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "all", true)
                 ...
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Sender"; "Parser"; "Response"; "Utils"; "Imap_uint"
                        ];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "imap";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Imap_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "imap";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Imap_gsasl"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "imap";
                      lib_findlib_name = Some "gsasl";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-lssl"; "-lcrypto"; "-v"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_set.ml"});
               Executable
                 ({
                     cs_name = "test_mutf7";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_mutf7.ml"});
               Executable
                 ({
                     cs_name = "test_live";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_live.ml"});
               Executable
                 ({
                     cs_name = "test_io";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_io.ml"});
               Executable
                 ({
                     cs_name = "test_condstore";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_condstore.ml"});
               Executable
                 ({
                     cs_name = "test_id";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_id.ml"});
               Executable
                 ({
                     cs_name = "test_namespace";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_namespace.ml"});
               Test
                 ({
                     cs_name = "test_parser";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "È\\bFÉ@º\148\001\127Ï\157u\014×Ö";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
